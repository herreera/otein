...
const navbarMainItems = [
  { ref: '/', label: 'INICIO' },
  { ref: '/shop', label: 'MERCHANDISING' },
];

const navbarSecondrayItems = [
  { ref: '/terms', label: 'TERMINOS & CONDICIONES' },
  { ref: '/shipping', label: 'ENVIO & DEVOLUCIONES' },
  { ref: '/faq', label: 'PREGUNTAS FRECUENTES' },
];
    ...
    <>
      ...
      >
        ...
        <ul className="flex flex-col items-center gap-4 justify-end mt-4 sm:mt-[140px]">
          ...
          <a href="https://www.instagram.com/elputootein/" target="_blank" rel="noopener noreferrer">
                <svg
              ...
              {/* YouTube Icon */}
              <a href="https://www.youtube.com/channel/UC3u0C-3wgJ8k8JmeGviiWFA" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 576 512"
                  className="w-5 h-5"
              ...
              {/* TikTok Icon */}
              <a href="https://www.tiktok.com/@otein" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="w-5 h-5"
